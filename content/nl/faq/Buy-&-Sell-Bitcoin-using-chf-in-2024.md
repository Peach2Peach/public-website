...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>Nationale Overschrijving Zwitserland</p> 
        <img src="/img/faq/logoimg/nationalswitzer.png" width="30px" height="27px" alt="Bitcoin kopen met Nationale Overschrijving Zwitserland, Bitcoin verkopen met Nationale Overschrijving Zwitserland">
    </div>
</div>
...
<div class="payment-grid">
    ...
    <div class="payment-grid-item">
       <p>Twint</p> 
        <img src="/img/faq/logoimg/twint.png" width="30px" height="27px" alt="Bitcoin kopen met Twint, Bitcoin verkopen met Twint">
    </div>
</div>
