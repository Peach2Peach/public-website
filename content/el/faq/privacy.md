...
:::details Ποιες είναι οι επιπτώσεις στην ιδιωτικότητα μιας προσφοράς άμεσης συναλλαγής;

Από προεπιλογή, τα στοιχεία πληρωμής κρυπτογραφούνται με PGP από άκρο σε άκρο μεταξύ εσάς και του αντισυμβαλλομένου σας.  
Στην περίπτωση μιας προσφοράς άμεσης συναλλαγής, οι πληροφορίες κοινοποιούνται επίσης στην Peach, ώστε να μπορούμε να τις στείλουμε στον αντισυμβαλλόμενο μόλις αποσταλεί το αίτημα συναλλαγής.
:::
