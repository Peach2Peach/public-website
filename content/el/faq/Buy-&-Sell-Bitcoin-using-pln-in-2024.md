...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>Εθνική Μεταφορά Πολωνία</p> 
        <img src="/img/faq/logoimg/poland.png" width="30px" height="27px" alt="Αγοράστε bitcoin με Εθνική Μεταφορά Πολωνία, Πωλήστε bitcoin με Εθνική Μεταφορά Πολωνία">
    </div>
</div>
...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>Blik</p> 
        <img src="/img/faq/logoimg/BLIK.png" width="30px" height="27px" alt="Αγοράστε bitcoin με Blik, Πωλήστε bitcoin με Blik">
    </div>
    <div class="payment-grid-item">
        <p>Neteller</p> 
