...
Εάν επιλέξετε το τελευταίο, Σας πληρώνουμε το 21% της αμοιβής που δημιουργείται από τις πρώτες 5 συναλλαγές που πραγματοποιούνται από τον χρήστη που συστήσατε (σημειώστε ότι η αμοιβή μας για την πρώτη συναλλαγή θα είναι 0% και στη συνέχεια 2%). Κάθε 1 πόντους παίρνετε 40 sats.  
