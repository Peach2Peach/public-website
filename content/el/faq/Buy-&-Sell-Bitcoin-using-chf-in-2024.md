...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>Εθνική Μεταφορά Ελβετίας</p> 
        <img src="/img/faq/logoimg/nationalswitzer.png" width="30px" height="27px" alt="Αγοράστε bitcoin με Εθνική Μεταφορά Ελβετίας, Πωλήστε bitcoin με Εθνική Μεταφορά Ελβετίας">
    </div>
</div>
...
<div class="payment-grid">
    ...
    <div class="payment-grid-item">
       <p>Twint</p> 
        <img src="/img/faq/logoimg/twint.png" width="30px" height="27px" alt="Αγοράστε bitcoin με Twint, Πωλήστε bitcoin με Twint">
    </div>
</div>
