...
- **ahorrar comisiones**, financiar todos los depósito de garantías en una sola transacción: por ejemplo, agrupar 5 pagos en una sola transacción puede ahorrarte fácilmente el 60% en comisiones de transacción.

## Cómo funciona

### Financiamiento desde la billetera Peach

Financiar tus ofertas de venta desde tu Billetera Peach es la opción más sencilla. Al hacer clic en el botón "financiar desde billetera Peach", la aplicación Peach se encarga de todo por ti. Crea una transacción de financiamiento que envía los fondos necesarios a cada dirección de depósito de garantía automáticamente.
...
2. **financiamiento y distribución**: Una vez que los sats llegan a esta dirección interna, la lógica de la aplicación Peach divide los fondos entre las ofertas de venta que has creado y los envía a las direcciones de depósito de garantía individuales.
...
:::details ¿Por qué no un solo depósito de garantía para muchas ofertas de venta?
Efectivamente, hemos estado contemplando cómo podemos tener solo un depósito de garantía del cual se puedan atender muchas ofertas de venta.
La razón por la que no usamos un solo depósito de garantía es que haría los pagos mucho más difíciles de realizar.
En la configuración actual los depósito de garantías se pagan en su totalidad en una sola transacción y se termina. Sin embargo, si tuviéramos que pagar parcialmente un depósito de garantía al comprador A, la naturaleza de la transacción de bitcoin nos dejaría con una salida de cambio de los sats que aún no se han gastado. Por simplicidad, digamos que el cambio vuelve a la misma dirección de depósito de garantía.
...
Para el proceso de dos pasos, se ahorran comisiones al financiar 3 depósito de garantías o más. Para evitar incurrir en más comisiones, no permitimos el financiamiento agrupado de dos ofertas de venta.
:::
