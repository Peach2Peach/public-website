...
keywords:
  - estafa Bitcoin P2P
  - estafa de triangulación
  - pago de terceros Bitcoin
  - seguridad Peach Bitcoin
  - comprar Bitcoin sin KYC seguro
  - protección de operaciones P2P
tags:
  - Security
  - Education
  - Disputes
...
description: |
  Las estafas de triangulación convierten a un tercero inocente en quien paga el Bitcoin de otra persona. Aquí te contamos cómo funciona la estafa y cómo Peach la frena.
---
...
<img src="/img/blog/triangulation-scams/hero.webp" alt="Diagrama de una estafa de triangulación: un triángulo que conecta a un estafador, una víctima inocente y un vendedor honesto, con Bitcoin fluyendo del vendedor al estafador, dinero en efectivo de la víctima al vendedor y una advertencia del estafador a la víctima" style="display:block; margin: auto; width: 70%;">
...
1. El estafador pone algo a la venta en un lugar totalmente distinto. Un teléfono, una entrada de concierto, un mueble en una web de anuncios clasificados, en eBay o Facebook Marketplace. Una venta normal, sin nada que ver con Bitcoin.
2. Un comprador (la víctima) acepta comprar ese artículo y se prepara para pagar.
3. En ese preciso momento, el estafador entra a nuestro mercado P2P de Bitcoin y toma una operación con un vendedor real.
4. El estafador pasa los datos bancarios del vendedor a la víctima, como si fueran sus propios datos para el artículo en venta.
5. La víctima transfiere el dinero al vendedor, creyendo que está pagando por un teléfono.
6. El vendedor ve llegar el dinero, confirma el pago y libera el Bitcoin al estafador.
