...
<div class="payment-grid">
    ...
    <div class="payment-grid-item">
        <p>Easypaisa</p> 
        <img src="/img/faq/logoimg/easypaisa.png" width="30px" height="27px" alt="Acheter du bitcoin avec Easypaisa, Vendre du bitcoin avec Easypaisa">
    </div>
    <div class="payment-grid-item">
        <p>NayaPay</p> 
        <img src="/img/faq/logoimg/nayapay.png" width="30px" height="27px" alt="Acheter du bitcoin avec NayaPay, Vendre du bitcoin avec NayaPay">
    </div>
    <div class="payment-grid-item">
        <p>SadaPay</p> 
        <img src="/img/faq/logoimg/sadapay.png" width="30px" height="27px" alt="Acheter du bitcoin avec SadaPay, Vendre du bitcoin avec SadaPay">
    </div>
</div>
