...
<div class="payment-grid">
    <div class="payment-grid-item">
        ...
        <img src="/img/faq/logoimg/blank.png" width="30px" height="27px" alt="Acheter du bitcoin avec National Trasnfer in Egypt, Vendre du bitcoin avec National Trasnfer in Egypt">
    </div>
</div>
...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>InstaPay</p> 
        <img src="/img/faq/logoimg/blank.png" width="30px" height="27px" alt="Acheter du bitcoin avec InstaPay, Vendre du bitcoin avec InstaPay">
    </div>
    <div class="payment-grid-item">
        <p>Vodafone Cash</p> 
        <img src="/img/faq/logoimg/vodafone.png" width="30px" height="27px" alt="Acheter du bitcoin avec Vodafone Cash, Vendre du bitcoin avec Vodafone Cash">
    </div>
    <div class="payment-grid-item">
        <p>Revolut</p> 
