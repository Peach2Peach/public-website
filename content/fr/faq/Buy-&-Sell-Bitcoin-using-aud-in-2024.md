...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>Osko</p> 
        <img src="/img/faq/logoimg/osko.png" width="30px" height="27px" alt="Acheter du bitcoin avec Osko, Vendre du bitcoin avec Osko">
    </div>
    <div class="payment-grid-item">
        <p>PayID</p> 
        <img src="/img/faq/logoimg/payid.png" width="30px" height="27px" alt="Acheter du bitcoin avec PayID, Vendre du bitcoin avec PayID">
    </div>
    <div class="payment-grid-item">
        <p>Wise</p> 
