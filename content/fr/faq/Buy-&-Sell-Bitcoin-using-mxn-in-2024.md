...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>SPEI</p> 
        <img src="/img/faq/logoimg/blank.png" width="30px" height="27px" alt="Acheter du bitcoin avec spei, Vendre du bitcoin avec spei">
    </div>
    <div class="payment-grid-item">
        <p>STP</p> 
        <img src="/img/faq/logoimg/blank.png" width="30px" height="27px" alt="Acheter du bitcoin avec stp, Vendre du bitcoin avec stp">
    </div>
</div>
