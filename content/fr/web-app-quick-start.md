...
# Démarrage rapide de la web app
...
Sur votre ordinateur, ouvrez [web.peachbitcoin.com](https://web.peachbitcoin.com). Un code QR de connexion s'affiche. **Vérifiez toujours que vous êtes sur la bonne URL : web.peachbitcoin.com**

![](/img/faq/web-quickstart/pairing/02-scan-icon.webp)
Sur votre téléphone, ouvrez l'app Peach et touchez « Se connecter à l'ordinateur » (sur Android, l'option se trouve dans les paramètres)
...
Parcourez le carnet d'ordres complet et filtrez les offres par devise et méthode de paiement

![](/img/faq/web-quickstart/trading/02-create-offer.webp)
Créez vos propres offres d'achat ou de vente selon vos préférences
...
Mettre fin à une session est simple : fermer la fenêtre suffit à vous déconnecter. C'est particulièrement pratique sur un ordinateur partagé ou public.

:::quickstarts 1
![](/img/faq/web-quickstart/sessions/log-out.webp)
Vous pouvez aussi vous déconnecter à tout moment avec le bouton en haut à droite
:::

D'autres questions ? Consultez la [FAQ de la web app](/fr/faq/web-app/) !
