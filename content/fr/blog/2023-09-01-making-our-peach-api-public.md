...
![Capture d'écran du terminal : une requête curl vers l'API Peach renvoyant une réponse JSON de statut](/img/blog/making-our-peach-api-public/api-example.png)
