...
description: >
  Avec GroupHug, nous regroupons les libérations d'escrow pour réduire les frais
  de transaction. Inscrivez-vous, attendez un peu, économisez davantage. Vous
  gardez le contrôle, changez quand vous voulez.
---
