...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>Osko</p> 
        <img src="/img/faq/logoimg/osko.png" width="30px" height="27px" alt="Compra bitcoin con Osko, Vendi bitcoin con Osko">
    </div>
    <div class="payment-grid-item">
        <p>PayID</p> 
        <img src="/img/faq/logoimg/payid.png" width="30px" height="27px" alt="Compra bitcoin con PayID, Vendi bitcoin con PayID">
    </div>
    <div class="payment-grid-item">
        <p>Wise</p> 
