...
<div class="payment-grid">
    <div class="payment-grid-item">
        ...
        <img src="/img/faq/logoimg/blank.png" width="30px" height="27px" alt="Compra bitcoin con National Trasnfer in Egypt, Vendi bitcoin con National Trasnfer in Egypt">
    </div>
</div>
...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>InstaPay</p> 
        <img src="/img/faq/logoimg/blank.png" width="30px" height="27px" alt="Compra bitcoin con InstaPay, Vendi bitcoin con InstaPay">
    </div>
    <div class="payment-grid-item">
        <p>Vodafone Cash</p> 
        <img src="/img/faq/logoimg/vodafone.png" width="30px" height="27px" alt="Compra bitcoin con Vodafone Cash, Vendi bitcoin con Vodafone Cash">
    </div>
    <div class="payment-grid-item">
        <p>Revolut</p> 
