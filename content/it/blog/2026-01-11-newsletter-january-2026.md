...
Il 2026 è arrivato! Speriamo che i vostri propositi di inizio anno reggano ancora e prevedano di chiudere l'anno con più sat.

Ecco la nostra pipeline, un piccolo sfogo e un breve aggiornamento sul mercato.

## Cosa c'è nella nostra pipeline

Il 2025 è stato un grande anno. Abbiamo rilasciato la v.69, sbloccando la simmetria e permettendo ai compratori di pubblicare offerte. Qualche bug all'inizio, ma il nostro eccellente Dev Alex li ha macinati uno a uno. L'app ha ricevuto una bella rifinitura e nuove feature luccicanti.

E per il 2026?

Abbiamo appena ricalibrato il nostro piano annuale per portarvi **Peach Web**. Una versione di Peach sotto forma di progressive web app, che funzionerà in un browser, sia su mobile che su desktop.

Accidenti! E perché?

Beh, risolverebbe un paio di cose (molto importanti):

1. Possiamo sfuggire alla tirannia di Apple e Google (ed evitare di restare bloccati su TestFlight).
2. I trader ad alto volume possono accedere a uno schermo grande e a un modo più comodo di gestire il loro trading.

Cos'altro? Stiamo aggiungendo più stablecoin come metodo di pagamento, e intensificheremo gli sforzi per espandere la nostra base di utenti verso l'America Latina.

Eccoci qui, iniziamo il 2026 con un piano ambizioso.

Pensate che ci debba essere qualcos'altro nella nostra pipeline? Fatecelo sapere sul nostro canale Telegram o alla mail hello@peachbitcoin.com.
...
Inoltre, stiamo lavorando sul server per migliorare la velocità, l'efficienza e la resilienza del nostro backend. Speriamo che ciò si rifletta anche sulla velocità dell'app!

## Aggiornamento del mercato Peach

Alcune statistiche dall'11 dicembre all'11 gennaio 2026.
...
- Il volume continua a crescere lentamente: **CHF 610K** nell'ultimo mese (+15% rispetto a novembre).
