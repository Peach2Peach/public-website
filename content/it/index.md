---
template: index
description: Compra e vendi Bitcoin peer-to-peer senza KYC. Peach è un marketplace mobile non-custodial per transazioni private e anonime, disponibile su iOS, Android e APK.
---
...
:::buttons
<button class="btn" id="customBtn" alt="Peachbitcoin P2P Orderbook, TOP NOKYC OrderBook, KycFree orderbook, Orderbook NOKYC" onclick="window.location.href='/it/p2p-orderbook'">Controlla il libro degli ordini in tempo reale</button>
:::
...
:::buttons
[Controlla i nostri metodi di pagamento](/faq/pm/#supported-payment-methods)
:::

Vendi al **prezzo che preferisci** perché i mercati peer-to-peer sono i veri mercati.

**Il Bitcoin senza registrazione è il Bitcoin più sicuro.**
