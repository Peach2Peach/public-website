...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>GCash</p> 
        <img src="/img/faq/logoimg/gcash.png" width="30px" height="27px" alt="Купуйте біткоїн за допомогою GCash, Продавайте біткоїн за допомогою GCash">
    </div>
    <div class="payment-grid-item">
        <p>Wise</p> 
