...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>PayLah!</p> 
        <img src="/img/faq/logoimg/paylah.jpg" width="30px" height="27px" alt="Купуйте біткоїн за допомогою PayLah!, Продавайте біткоїн за допомогою PayLah!">
    </div>
    <div class="payment-grid-item">
        <p>Wise</p> 
