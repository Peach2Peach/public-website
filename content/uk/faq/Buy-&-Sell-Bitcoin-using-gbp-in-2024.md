...
<div class="payment-grid">
    <div class="payment-grid-item">
        <p>Faster Payments</p> 
        <img src="/img/faq/logoimg/fasterpayment.png" width="30px" height="27px" alt="Купуйте біткоїн за допомогою Faster Payments, Продавайте біткоїн за допомогою Faster Payments">
    </div>
</div>
