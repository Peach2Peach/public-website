...
![Captura de tela do terminal: uma requisição curl para a API Peach retornando uma resposta JSON de status](/img/blog/making-our-peach-api-public/api-example.png)
