...
2026 chegou! Esperamos que as vossas resoluções de Ano Novo ainda estejam de pé e incluam acabar o ano com mais sats.

Aqui está o nosso pipeline, um pequeno desabafo e uma breve atualização do mercado.

## O que está no nosso pipeline

2025 foi um grande ano. Lançámos a v.69, destrancando a simetria e permitindo aos compradores publicarem ofertas. Alguns bugs no início, mas o nosso excelente Dev Alex tem vindo a esmagá-los. A app ganhou um bom polimento e novas funcionalidades brilhantes.

E para 2026?

Acabámos de redirecionar o nosso plano anual para vos trazer o **Peach Web**. Uma versão do Peach em forma de progressive web app, que funcionará no browser, tanto no mobile como no desktop.

E porquê?

Bom, resolveria algumas coisas (muito importantes):

1. Conseguimos fugir à tirania da Apple e da Google (e evitar ficar presos no TestFlight).
2. Os traders de alto volume ganham acesso a um ecrã grande e a uma forma mais confortável de gerir o seu trading.

Mais o quê? Estamos a adicionar mais stablecoins como método de pagamento, e vamos intensificar os nossos esforços para expandir a nossa base de utilizadores à América Latina.

E assim começamos 2026 com um plano ambicioso.

Achas que deveria haver mais alguma coisa no nosso pipeline? Diz-nos no nosso canal do Telegram ou pelo email hello@peachbitcoin.com.
...
Além disso, estamos a trabalhar no servidor para melhorar a velocidade, eficiência e resiliência do nosso backend. Esperemos que isto também se reflita na velocidade da app!

## Atualização do mercado Peach

Algumas estatísticas de 11 de dezembro a 11 de janeiro de 2026.
...
- O volume continua a crescer lentamente: **CHF 610K** no último mês (+15% face a novembro).
