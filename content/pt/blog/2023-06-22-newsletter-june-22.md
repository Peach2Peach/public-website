...
description: >
  O Bitcoin é dinheiro para pessoas livres. Acreditamos que todo ser humano tem
  ...
  mais fácil para comprar e vender Bitcoin de forma peer to peer (P2P). A missão
  da Peach é contribuir para a adoção do Bitcoin pelas pessoas.
---
...
Estamos procurando por mais idiomas primeiro, e posteriormente expandindo para o restante do mundo.
