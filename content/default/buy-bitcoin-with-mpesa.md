...
## Buy Bitcoin KYC-free with M-Pesa

In this article, you will be guided on how to buy Bitcoin (sats) with M-Pesa without the need for KYC (Know Your Customer) verification using PeachBitcoin. If you are not yet familiar with how Peach Bitcoin operates, please refer to our [Quick Start Guide](https://peachbitcoin.com/quick-start).
