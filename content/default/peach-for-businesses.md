...
### Sell from BTCPay-server

If you are a marchant using BTCPay Server, you can use the [Peach plugin](https://peachbitcoin.com/it/blog/btcpay-plugin/) to sell for fiat the payments received on your store.
:::
::::
