...
If you are a merchant using BTCPay Server, you can use the [Peach plugin](https://peachbitcoin.com/blog/btcpay-plugin/) to sell for fiat the payments received on your store.
:::
::::
