...
1. We can escape the tyranny of Apple and Google (and avoid staying stuck on TestFlight).
2. High-volume traders can get access to a large screen and an easier way to manage their trading.
