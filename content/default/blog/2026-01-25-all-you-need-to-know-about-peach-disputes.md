---
keywords:
  - Peach bitcoin P2P marketplace
  - Self-custody
  - Multi-sig
  - multisignature escrow
  - 2-out-of-2 multisig escrow
  - secure transaction
  - Bitcoin escrow security
  - stack sat with peach
  - p2p
  - Peach Bitcoin dispute process
  - P2P Bitcoin trading disputes
  - Peach Bitcoin app
...
**Others**: You can also initiate a dispute if the buyer has violated the [terms and conditions](https://peachbitcoin.com/terms-and-conditions/). For example, You are advised to continue the transaction through another platform or outside the Peach App. You can find more information about how trade disputes are handled [in our FAQ](https://peachbitcoin.com/support/). 
...
**Others:** You can also initiate a dispute if the buyer has violated the transaction policies. For example, You are advised to continue the transaction through another platform or outside the Peach App. You can find more information about how disputes are handled on Peach[ in our FAQ. ](https://peachbitcoin.com/support/)
...
1. Be clear when you open the dispute in order to avoid mediator confusion. Communicate clearly the kind of action you need mediators' help with, either for canceling the order or releasing the order.  
2. Send relevant proof like proof of payment or no payment being made, don't attach a screenshot of conversations with the counterpart as proof of payment. 
3. Please allow mediators to respond to your dispute within a few hours to 24 hours
4. Do not use abusive language with the mediator and your counterpart during the dispute process
5. Always communicate using the in-App chat or via email if asked to, so that the mediator can follow the conversations ongoing between buyer and seller to avoid confusion.
...
**Get Started With Peach Bitcoin.**
...
**For more information on Peach Bitcoin, you can read our helpful resources&#32;[on our website.](https://peachbitcoin.com/support/)