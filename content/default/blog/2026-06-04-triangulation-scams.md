...
keywords:
  - P2P Bitcoin scam
  - triangulation scam
  - third party payment Bitcoin
  - Peach Bitcoin security
  - buy Bitcoin no KYC safe
...
description: |
  Triangulation scams turn an innocent third party into the one who pays for someone else's Bitcoin. Here's how the scam works, and how Peach shuts it down.
---
...
<img src="/img/blog/triangulation-scams/hero.webp" alt="Diagram of a triangulation scam: a triangle linking a scammer, an unwitting victim, and an honest seller, with Bitcoin flowing from the seller to the scammer, cash from the victim to the seller, and a warning from the scammer to the victim" style="display:block; margin: auto; width: 70%;">
...
1. The scammer lists something for sale somewhere else entirely. A phone, a concert ticket, a piece of furniture on a classifieds site, on eBay or Facebook Marketplace. A normal sale, nothing to do with Bitcoin.
2. A buyer (the victim) agrees to buy that item and gets ready to pay.
3. At that exact moment, the scammer jumps onto our P2P Bitcoin marketplace and takes a trade with a real seller.
4. The scammer passes the seller's bank details to the victim, as if those were the scammer's own details for the item being sold.
5. The victim transfers the money to the seller, believing they are paying for a phone.
6. The seller sees the money land, confirms the payment, and releases the Bitcoin to the scammer.
